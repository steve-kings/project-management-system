        ...
        <div className="w-full bg-white dark:bg-zinc-900 border-b border-gray-200 dark:border-zinc-800 px-6 xl:px-16 py-3 flex-shrink-0">
            <div className="flex items-center justify-between max-w-6xl mx-auto">
                ...
                <div className="flex items-center gap-3">
                    ...
                    {/* Logout Button */}
                    <button onClick={handleLogout} className="size-8 flex items-center justify-center bg-white dark:bg-zinc-800 shadow rounded-lg transition hover:scale-105 active:scale-95" title="Logout">
                        <LogOut className="size-4 text-gray-800 dark:text-gray-200" />
                    </button>

                    {/* User Avatar */}
                    <img src={user?.image || 'https://via.placeholder.com/40'} alt="User Avatar" className="size-7 rounded-full" />
                </div>
            </div>
        </div>
    )
