...
const workspaceSlice = createSlice({
    ...
    reducers: {
        ...
        setCurrentWorkspace: (state, action) => {
            ...
            state.currentWorkspace = state.workspaces.find((w) => w._id === action.payload || w.id === action.payload);
        },
        ...
        addProject: (state, action) => {
            ...
            state.workspaces = state.workspaces.map((w) =>
                (w._id === state.currentWorkspace._id || w.id === state.currentWorkspace.id) 
